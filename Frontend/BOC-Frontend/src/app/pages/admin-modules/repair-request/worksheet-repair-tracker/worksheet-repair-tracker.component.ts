...
@Component({
  selector: 'app-worksheet-repair-tracker',
  templateUrl: './worksheet-repair-tracker.component.html',
  styleUrls: ['./worksheet-repair-tracker.component.scss']
})
export class WorksheetRepairTrackerComponent implements OnInit {
  submitted: boolean;
  ...
  callPdf() {
    this.getPdfBase64((pdfBase64) => {
      ...
      this._FileSaverService.save(blob, `incoming-checklist.pdf`);
      Swal.fire({
        title: 'Success!',
