...
@Component({
  selector: 'app-outgoing-repair-tracker',
  templateUrl: './outgoing-repair-tracker.component.html',
  styleUrls: ['./outgoing-repair-tracker.component.scss']
})
export class OutgoingRepairTrackerComponent implements OnInit {
  submitted: boolean;
  ...
  callPdf() {
    this.getPdfBase64((pdfBase64) => {
      ...
      this._FileSaverService.save(blob, `outgoing-checklist.pdf`);
      Swal.fire({
        title: 'Success!',
