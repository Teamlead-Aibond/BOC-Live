...
@Component({
  selector: "app-rr-vendor-quote-attachment-selected-list",
  templateUrl: "./rr-vendor-quote-attachment-selected-list.component.html",
  styleUrls: ["./rr-vendor-quote-attachment-selected-list.component.scss"],
  providers: [NgxSpinnerService],
})
export class RrVendorQuoteAttachmentSelectedListComponent implements OnInit {
  // bread crumb items
  ...
  ngOnInit() {
    ...
    this.VQAttachmentIds = this.route.snapshot.params.id;
  ...
  onSearch() {
    if (this.IsViewEnabled) {
      ...
      var postData = {
        ...
        VendorId: "",
        Created: CD,
        VQAttachmentIds: atob(this.VQAttachmentIds),
        pagination: {
