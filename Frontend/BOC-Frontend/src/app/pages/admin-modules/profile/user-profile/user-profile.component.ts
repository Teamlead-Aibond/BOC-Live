...
export class UserProfileComponent implements OnInit {
  ...
  DepartmentList;  constructor(
    ...
    getViewContent() {
      ...
      this.commonService.postHttpService(postData,"getUserView").subscribe(response => {
    ...
    onSubmit() {
      ...
      if (this.UserForm.valid) {
        ...
        var postData = {
          IdentityId:localStorage.getItem("UserId"),
          UserList: [{
        ...
        this.commonService.putHttpService(postData, "getUserUpdate").subscribe(response => {
          if (response.status == true) {
            Swal.fire({
              title: 'Success!',
