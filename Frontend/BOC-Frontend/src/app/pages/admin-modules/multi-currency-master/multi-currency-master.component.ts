...
@Component({
  selector: 'app-multi-currency-master',
  templateUrl: './multi-currency-master.component.html',
  styleUrls: ['./multi-currency-master.component.scss']
})
export class MultiCurrencyMasterComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.service.getHttpService('GetCurrencyList').subscribe(response => {
  ...
  addCurrency() {
    var CurrencyId = '';
    this.modalRef = this.modalService.show(MultiCurrencyComponent,
      {
        backdrop: 'static',
  ...
  deleteCurrency(CurrencyId) {
    Swal.fire({
      ...
      if (result.value) {
        ...
        this.service.postHttpService(postData, 'DeleteCurrency').subscribe(response => {
          if (response.status == true) {
