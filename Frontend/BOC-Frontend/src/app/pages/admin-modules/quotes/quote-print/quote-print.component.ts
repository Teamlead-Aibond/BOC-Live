...
export class QuotePrintComponent implements OnInit {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        that.api_check = that.http
          ...
          .subscribe((resp) => {
            ...
            if (this.Type == "MRO") {
              this.loadTemplate("add", this.Type);
            } else {
  ...
  generateExcelFormat() {
    ...
    workbook.xlsx.writeBuffer().then((data) => {
      ...
      fs.saveAs(blob, "Sales Quote.xlsx");
    });
  }
        ...
        this.service.postHttpService(postData, "getSalesQuotesView").subscribe(
          (response) => {
            if (response.status == true) {
              ...
              this.SalesQuotesCustomerRef = this.result.CustomerRef || [];
