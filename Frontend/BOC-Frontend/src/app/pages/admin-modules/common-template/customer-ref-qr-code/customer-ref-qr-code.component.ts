...
@Component({
  selector: 'app-customer-ref-qr-code',
  templateUrl: './customer-ref-qr-code.component.html',
  styleUrls: ['./customer-ref-qr-code.component.scss']
})
export class CustomerRefQrCodeComponent implements OnInit {
