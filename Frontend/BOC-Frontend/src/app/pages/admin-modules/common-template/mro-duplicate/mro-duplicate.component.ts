...
@Component({
  selector: 'app-mro-duplicate',
  templateUrl: './mro-duplicate.component.html',
  styleUrls: ['./mro-duplicate.component.scss']
})
export class MroDuplicateComponent implements OnInit {
  ...
  if(f.valid){
      ...
      this.commonService.postHttpService(postData, "MRODuplicate").subscribe(response => {
