...
import { footerlineRight, footerlineLeft, CONST_VIEW_ACCESS, CONST_APPROVE_ACCESS, customergroup } from 'src/assets/data/dropdown';
import { environment } from 'src/environments/environment';
import Swal from 'sweetalert2';
import * as fs from 'file-saver';

@Component({
  selector: 'app-amazon-raw-report',
  templateUrl: './amazon-raw-report.component.html',
  styleUrls: ['./amazon-raw-report.component.scss']
})
export class AmazonRawReportComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.IsViewEnabled = this.commonService.permissionCheck("AmazonOOWRRawReport", CONST_VIEW_ACCESS);
     this.DownloadExcelCSVinReports = this.commonService.permissionCheck("AmazonOOWRRawReport", CONST_APPROVE_ACCESS);

    if(this.IsViewEnabled){
      this.getCustomerGroupList()
    this.loadCustomers();
    this.onAmazonOOWR_RawReport();
  ...
  //Amazon OOWR_Raw Report
  onAmazonOOWR_RawReport() {
    const httpOptions = {
    ...
    var url = this.baseUrl + '/api/v1.0/RRReports/CustomerReportAmazonRaw';
    const that = this;
    var filterData = {
    ...
    this.dtOptions["columns"] = [
      { data: 'RepairRequest', width: '10%', name: 'RepairRequest', defaultContent: '', orderable: true, searchable: true },
      { data: 'APN', width: '25%', name: 'APN', defaultContent: '', orderable: true, searchable: true },
      { data: 'Serial', width: '20%', name: 'Serial', defaultContent: '', orderable: true, searchable: true },
      { data: 'Description', width: '10%', name: 'Description', defaultContent: '', orderable: true, searchable: true },
      { data: 'SiteCode', width: '25%', name: 'SiteCode', defaultContent: '', orderable: true, searchable: true },
      { data: 'RepairPrice', width: '10%', name: 'RepairPrice', defaultContent: '', orderable: true, searchable: true },
      { data: 'RootCause', width: '50%', name: 'RootCause', defaultContent: '', orderable: true, searchable: true },
      ...
      { data: 'PartPrice', width: '20%', name: 'PartPrice', defaultContent: '', orderable: true, searchable: true },
      { data: 'OpenDate', width: '20%', name: 'OpenDate', defaultContent: '', orderable: true, searchable: true },
      ...
      { data: 'QuoteRejected', width: '20%', name: 'QuoteRejected', defaultContent: '', orderable: true, searchable: true },
      { data: 'DateshippedbacktoFC', width: '20%', name: 'DateshippedbacktoFC', defaultContent: '', orderable: true, searchable: true },
      { data: 'QuoteRejectedType', width: '20%', name: 'QuoteRejectedType', defaultContent: '', orderable: true, searchable: true },
    ...
    this.dataTable = $('#datatable-angular-rawreport');
  ...
  getdtOption() {
    ...
    return {
      ...
      "preDrawCallback": function () {
        $('#datatable-angular-rawreport_processing').attr('style', 'display: block; z-index: 10000 !important');
  ...
  onExportToCSV() {
    ...
    this.spinner = true
    this.commonService.postHttpService(postData, "CustomerReportAmazonRawCSV").subscribe(response => {
