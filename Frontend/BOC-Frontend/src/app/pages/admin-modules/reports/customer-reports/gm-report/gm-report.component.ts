...
@Component({
  selector: 'app-gm-report',
  templateUrl: './gm-report.component.html',
  styleUrls: ['./gm-report.component.scss']
})
export class GmReportComponent implements OnInit {
  ...
  onGMReport() {
    ...
    var url = this.baseUrl + '/api/v1.0/RRReports/GMCostSavingReport';
    const that = this;
    var filterData = {
    ...
    this.dtOptions["columns"] = [
      ...
      { data: 'Directed', width: '25%', name: 'Directed', defaultContent: '', orderable: true, searchable: true },
      { data: 'Department', width: '20%', name: 'Department', defaultContent: '', orderable: true, searchable: true },
      ...
      { data: 'Common Code', width: '20%', name: 'Common Code', defaultContent: '', orderable: true, searchable: true },
      { data: 'GM PO', width: '20%', name: 'GM PO', defaultContent: '', orderable: true, searchable: true },
      ...
      { data: 'Assumed Repair Cost as per GM guidelines', width: '20%', name: 'Assumed Repair Cost as per GM guidelines', defaultContent: '', orderable: true, searchable: true, },
      { data: 'Previous Repair Cost', width: '5%', name: 'Previous Repair Cost', defaultContent: '', orderable: true, searchable: true },
      { data: 'GM Repair Cost', width: '20%', name: 'GM Repair Cost', defaultContent: '', orderable: true, searchable: true },
      ...
      { data: 'Repair vs New', width: '2%', name: 'Repair vs New', defaultContent: '', orderable: true, searchable: true, },
      { data: 'Savings', width: '5%', name: 'Savings', defaultContent: '', orderable: true, searchable: true, },
      { data: 'Other', width: '5%', name: 'Other', defaultContent: '', orderable: true, searchable: true, },
      { data: 'No Problem Found', width: '5%', name: 'No Problem Found', defaultContent: '', orderable: true, searchable: true, },
      { data: 'Notes', width: '5%', name: 'Notes', defaultContent: '', orderable: true, searchable: true, },
  ...
  onExportToCSV() {
    ...
    this.spinner = true
    this.commonService.postHttpService(postData, "GMCostSavingReportExcel").subscribe(response => {
  ...
  generateCSVFormat() {
    ...
    var filename = ('GM Cost Savings Report .csv')
    a.download = filename;
    a.click()
