...
@Component({
  selector: 'app-dana-open-order-report',
  templateUrl: './dana-open-order-report.component.html',
  styleUrls: ['./dana-open-order-report.component.scss']
})
export class DanaOpenOrderReportComponent implements OnInit {
  ...
  loadCount() {
    var postData = {};
    this.commonService.postHttpService(postData, "getDanaOpenOrderBySupplierReportCount").subscribe(response => {
  ...
  onFilterofOpenOrderBySupplierReport() {
    ...
    var url3 = this.baseUrl + '/api/v1.0/RRReports/DanaOpenOrderBySupplierReport';
    const that = this;
    var filterData = {
    ...
    this.dtOptions["columns"] = [
      ...
      // 
      { data: 'StartLocation', name: 'StartLocation', defaultContent: '', orderable: true, searchable: true, },
      { data: 'FirstShipToName', name: 'FirstShipToName', defaultContent: '', orderable: true, searchable: true, },
      { data: 'FirstShipDate', name: 'FirstShipDate', defaultContent: '', orderable: true, searchable: true, },

      // { data: 'ShipFromCustomer', name: 'ShipFromCustomer', defaultContent: '', orderable: true, searchable: true, },
      { data: 'QuoteDate', name: 'QuoteDate', defaultContent: '', orderable: true, searchable: true, },
      { data: 'ApprovedDate', name: 'ApprovedDate', defaultContent: '', orderable: true, searchable: true, },
      { data: 'SODueDate', name: 'SODueDate', defaultContent: '', orderable: true, searchable: true, },
      // 
      ...
      // 
      { data: 'MostRecentFollowUpDate', name: 'MostRecentFollowUpDate', defaultContent: '', orderable: true, searchable: true, },
  ...
  onExcel() {
    ...
    this.spinner = true
    this.commonService.postHttpService(postData, "getDanaOpenOrderBySupplierReport").subscribe(response => {
      if (response.status == true) {
  ...
  generateExcelFormat() {
    ...
    const title = 'Dana Open Order By Supplier Report';
    const header = ["Repair Request #", "Manufacturer", "Manufacturer Part #", "Serial #", "Description", "Status", "Starting Location", "Ship To", "Ship Date", "Quote Date", "Approved Date", "Due Date", "Repair Price", "Customer PO #", "Customer Reference #1", "Customer Reference #2", "Customer Reference #3", "Last Follow Up Note"]
    ...
    workbook.xlsx.writeBuffer().then((data) => {
      ...
      var filename = ('Dana Open Order By Supplier Report ' + currentDate + '.xlsx')
