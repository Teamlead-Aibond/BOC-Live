...
export class MonthlyInvoiceReportComponent implements OnInit {
  ...
  onList() {
    ...
    var url = this.baseUrl + '/api/v1.0/InvoiceReports/InvoiceByMonthNew';
    const that = this;
...
// <a href="#" class="fas fa-file-csv text-primary actionViewCSV" data-toggle='tooltip' title='Month CSV Download' data-placement='top' ></a> &nbsp;
    ...
    return {
      ...
      createdRow: function (row, data, index) {
        ...
        $('.actionView1', row).bind('click', (e) => {
          e.preventDefault();
          e.stopPropagation();
          that.router.navigate(['/admin/reports/Monthly-Invoice-Report-New'], { state: { Month: data.Month, Year: data.Year, CurrencyCode: data.LCC, CreatedByLocation: data.CreatedByLocation, IncludeRR: that.IncludeRR } });
      ...
      rowCallback: (row: Node, data: any | Object, index: number) => {
        ...
        $('.actionView1', row).bind('click', (e) => {
          e.preventDefault();
          e.stopPropagation();
          this.router.navigate(['/admin/reports/Monthly-Invoice-Report-New'], { state: { Month: data.Month, Year: data.Year, IncludeRR: that.IncludeRR } });
  ...
  onExcel() {
    ...
    this.spinner = true
    this.commonService.postHttpService(postData, "getInvoiceByMonthReportToExcelNew").subscribe(response => {
      if (response.status == true) {
  ...
  generateInvoicedetailsExcelFormat() {
    ...
    const header = ["InvoiceNo", "PartNo", "SONo", "CompanyName", "InvoiceDate", "Quantity", "Currency", "Price", "Cost", "Discount", "ExtPrice", "ExtCost", "Profit", "GP"]
