...
@Component({
  selector: 'app-lpp-rr-report',
  templateUrl: './lpp-rr-report.component.html',
  styleUrls: ['./lpp-rr-report.component.scss']
})
export class LppRrReportComponent implements OnInit {
  //Server Side
  ...
  ngOnInit(): void {
    ...
    this.loadCustomers();
    this.onFilterofTotalCostSavingsvsLLP();
  ...
  //Total Cost Saving vs LLP
  onFilterofTotalCostSavingsvsLLP() {
    const httpOptions = {
    ...
    var url2 = this.baseUrl + '/api/v1.0/RRReports/getTotalCostSavingsVsLastPricePaidReport';
    const that = this;
    var filterData = {
    ...
    this.dtOptions["ajax"] = (dataTablesParameters: any, callback) => {
      ...
      that.api_check = that.http.post<any>(url2,
    ...
    this.dtOptions["columns"] = [
      ...
      { data: 'Description', width: '50%', name: 'CompanyName', defaultContent: '', orderable: true, searchable: true },
      { data: 'CompanyName', width: '20%', name: 'CompanyName', defaultContent: '', orderable: true, searchable: true },
      { data: 'PreviousRepairRate', width: '10%', name: 'CompanyName', defaultContent: '', orderable: true, searchable: true },
      { data: 'NewRepairRate', width: '10%', name: 'CompanyName', defaultContent: '', orderable: true, searchable: true },
    ...
    this.dataTable = $('#datatable-angular-TotalCostSavingsVsLastPricePaidReport');
  ...
  onExcel() {
    ...
    this.spinner = true
    this.commonService.postHttpService(postData, "getTotalCostSavingsVsLastPricePaidReportExportToExcel").subscribe(response => {
  ...
  generateExcelFormat() {
    ...
    const title = 'Total Cost Savings Vs Last Price Paid';
    const header = ["Part No", "Description", "RR No", "Customer Name", "Previous Repair Rate", "New Repair Rate", "Difference", "Percentage"]
    ...
    workbook.xlsx.writeBuffer().then((data) => {
      ...
      var filename = ('Total Cost Savings Vs LPP ' + currentDate + '.xlsx')
