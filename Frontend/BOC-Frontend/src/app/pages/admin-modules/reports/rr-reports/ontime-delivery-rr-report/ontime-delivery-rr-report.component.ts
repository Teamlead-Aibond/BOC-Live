...
import { footerlineRight, footerlineLeft } from 'src/assets/data/dropdown';
...
@Component({
  selector: 'app-ontime-delivery-rr-report',
  templateUrl: './ontime-delivery-rr-report.component.html',
  styleUrls: ['./ontime-delivery-rr-report.component.scss']
})
export class OntimeDeliveryRrReportComponent implements OnInit {
  ...
  onFilterofOnTimeDelivery() {
    ...
    var url3 = this.baseUrl + '/api/v1.0/RRReports/getOnTimeDeliveryReport';
    const that = this;
    var filterData = {
    ...
    this.dtOptions["columns"] = [
      ...
      { data: 'Description', width: '40%', name: 'CompanyName', defaultContent: '', orderable: true, searchable: true },
      { data: 'DueDateAtTimeOfOrder', width: '10%', name: 'CompanyName', defaultContent: '', orderable: true, searchable: true },
      { data: 'ActualDateShipped', width: '10%', name: 'ActualDateShipped', defaultContent: '', orderable: true, searchable: true },
      { data: 'DifferenceInDays', width: '10%', name: 'DifferenceInDays', defaultContent: '', orderable: true, searchable: true, },
      { data: 'FromDate', width: '2%', name: 'FromDate', defaultContent: '', orderable: true, searchable: true, },
      { data: 'ToDate', width: '5%', name: 'ToDate', defaultContent: '', orderable: true, searchable: true, },
      { data: 'CustomerId', width: '5%', name: 'CustomerId', defaultContent: '', orderable: true, searchable: true, },

    ];

    this.dataTable = $('#datatable-angular-OnTimeDeliveryReport');
  ...
  onExcel() {
    ...
    this.spinner = true
    this.commonService.postHttpService(postData, "getOnTimeDeliveryReportExportToExcel").subscribe(response => {
  ...
  generateExcelFormat() {
    ...
    const title = 'On Time Delivery Report';
    const header = ["Part No", "Description", "RR No", "Customer Name", "Due Date At Time Of Order", "Actual Date Shipped", "Difference In Days"]
    ...
    workbook.xlsx.writeBuffer().then((data) => {
      ...
      var filename = ('On Time Delivery Report ' + currentDate + '.xlsx')
