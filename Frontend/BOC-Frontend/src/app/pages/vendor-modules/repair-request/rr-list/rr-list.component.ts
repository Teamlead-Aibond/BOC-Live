...
import { rr_status_vendor } from 'src/assets/data/dropdown';
import { environment } from 'src/environments/environment';
import Swal from 'sweetalert2';

@Component({
  selector: 'app-rr-list',
  templateUrl: './rr-list.component.html',
  styleUrls: ['./rr-list.component.scss']
})
export class RRListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.StatusName == '' || this.StatusName == 'undefined' || this.StatusName == null) {
      this.navCtrl.navigate('/vendor/dashboard');
      return false;
    }
    ...
    var url = this.baseUrl + '/api/v1.0/VendorPortal/VendorStatisticsRRList';
    const that = this;
    var filterData = {
    ...
    this.dtOptions = {
      ...
      createdRow: function (row, data, index) {
        ...
        //   case "RR Generated": { cstyle = 'badge-pink'; break; }
        //   case "RR Needs To Be Sourced": { cstyle = 'badge-danger'; break; }
        //   case "Awaiting Vendor Quote": { cstyle = 'badge-warning'; break; }
        //   case "Needs To Be Resourced": { cstyle = 'badge-purple'; break; }
        //   case "Customer Quote Submitted": { cstyle = 'badge-primary'; break; }
        //   case "Repair In Progress": { cstyle = 'badge-secondary'; break; }
        //   case "Quote Rejected": { cstyle = 'badge-light'; break; }
        //   case "Submitted": { cstyle = 'badge-info'; break; }
        //   case "Completed": { cstyle = 'badge-success'; break; }
        //   //case "Needs Sourcing": { cstyle = 'badge-purple'; break; }
        //   default: { cstyle = ''; break; }
        // }
        // var html = '<span class="badge ' + cstyle + ' btn-xs">' + data.StatusName + '</span>';
      },
      columns: [
        {
