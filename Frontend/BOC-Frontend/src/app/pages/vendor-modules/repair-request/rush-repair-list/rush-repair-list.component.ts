...
@Component({
  selector: "app-rush-repair-list",
  templateUrl: "./rush-repair-list.component.html",
  styleUrls: ["./rush-repair-list.component.scss"],
})
export class RushRepairListComponent implements OnInit {
