...
@Component({
  selector: "app-vendor-rr-list",
  templateUrl: "./vendor-rr-list.component.html",
  styleUrls: ["./vendor-rr-list.component.scss"],
})
export class VendorRrListComponent implements OnInit {
