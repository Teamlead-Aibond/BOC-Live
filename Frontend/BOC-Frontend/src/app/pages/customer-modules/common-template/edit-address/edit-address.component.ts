...
export class EditAddressComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.AddressForm.setValue({
      ...
      Fax: this.result.Fax,
      IsContactAddress: this.result.IsContactAddress,
      IsShippingAddress: this.result.IsShippingAddress,
      IsBillingAddress: this.result.IsBillingAddress,
    })
  ...
  onSubmit() {
    ...
    if (this.AddressForm.valid) {
      ...
      this.commonService.putHttpService(postData, "UpdateAddressCustomer").subscribe(response => {
        if (response.status == true) {
