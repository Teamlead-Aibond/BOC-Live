...
import { Const_Alert_pop_title, Const_Alert_pop_message, customer_quote_reject_reasons_customer_portal } from 'src/assets/data/dropdown';
...
export class RejectquoteComponent implements OnInit {
    ...
    ngOnInit(): void {
      ...
      this.customer_quote_reject_reasons = customer_quote_reject_reasons_customer_portal;
    }
        ...
        if (this.MROId == undefined) {
          Swal.fire({
            ...
            if (result.value) {
              ...
              this.commonService.postHttpService(postData, "RejectQuote").subscribe(response => {
