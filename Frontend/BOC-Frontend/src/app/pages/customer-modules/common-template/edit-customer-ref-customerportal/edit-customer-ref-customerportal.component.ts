...
@Component({
  selector: 'app-edit-customer-ref-customerportal',
  templateUrl: './edit-customer-ref-customerportal.component.html',
  styleUrls: ['./edit-customer-ref-customerportal.component.scss']
})
export class EditCustomerRefCustomerportalComponent implements OnInit {
    submitted = false;
    model: any = [];
    index;
    result
      ...
      if (f.valid) {
        var postData = {
          "CustomerReference": {
            ...
            "IsEditableByCustomer":this.result.IsEditableByCustomer
          }
