...
export class UserProfileComponent implements OnInit {
  ...
  DepartmentList;  constructor(
    ...
    getViewContent() {
      ...
      this.commonService.getHttpService("ViewCustomerUserProfile").subscribe(response => {
    ...
    onSubmit() {
      ...
      if (this.UserForm.valid) {
        ...
        this.commonService.putHttpService(postData, "UpdateCustomerUserProfile").subscribe(response => {
          if (response.status == true) {
            Swal.fire({
              title: 'Success!',
